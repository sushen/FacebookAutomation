...
def driver():
    ...
    febu_bot.goto_facebook_page_post("https://www.facebook.com/webScrapingpython/posts/122814976095518")

    time.sleep(5)
    
    article = febu_bot.driver.find_element_by_xpath("//div[@role='article'")
